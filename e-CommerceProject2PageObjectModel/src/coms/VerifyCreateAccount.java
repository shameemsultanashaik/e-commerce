...
public class VerifyCreateAccount extends Base {
	@Test
	public void accountCreation() throws IOException {
		...
		sn.clickSigIn();
		sn.clickCreateAccount("haroon123789@gmail.com");
...
//		cad.clickRegisterButton();
		...
		cad1.addFields("Haroon", "Rasheed", "Syed1976#", 25, 5, 46, "Aigebra", "3323 151st", "surrey", 10, "90210", 1, "510-366-6536");
