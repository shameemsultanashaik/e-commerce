...
public class VerifyCountryNull extends Base {
	@Test
	public void accountCreation() throws IOException {
		...
		sn.clickSigIn();
		sn.clickCreateAccount("syed123789@gmail.com");
...
//		cad.clickRegisterButton();
		...
		cad1.addFields("Haroon", "Rasheed", "Syed1976#", 25, 5, 46, "Aigebra", "3323 151st", "surrey", 10, "90210", 0, "510-366-6536");
		cad1.clickRegisterButton();
		
		
		
		String actualText0 =cad1.getcountryNullAthentication();
		String expectedText0="There are 3 errors\n"
